...
export function ProfileSettingsPage() {
  ...
  useEffect(() => { if (!twoFactor) { setQrCode(null); return; } void QRCode.toDataURL(twoFactor.otpauthUri, { width: 180, margin: 1 }).then(setQrCode); }, [twoFactor]);
